const WalkthroughConfig = {
  ...
  scenesConfig: {
    ...
    1: {
      'headline': 'Over the next few minutes, we will build a personalized alerts service for you using your answers to the following questions.',
    },
    2: {
      'arguments': ['name'],
    ...
    4: {
      'arguments': [],
      'headline': 'Have you traded crypto before?',
      'method': 'renderYesNo',
    },
    5: {
      'arguments': [],
